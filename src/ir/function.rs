    ...
    pub fn from_ty(
        ...
        if is_method || is_constructor || is_destructor {
            ...
            if !is_static && !is_virtual {
                ...
                let ptr =
                    Item::builtin_type(TypeKind::Pointer(class), false, false, false, ctx);
                args.insert(0, (Some("this".into()), ptr));
            } else if is_virtual {
                let void = Item::builtin_type(TypeKind::Void, false, false, false, ctx);
                let ptr = Item::builtin_type(TypeKind::Pointer(void), false, false, false, ctx);
                args.insert(0, (Some("this".into()), ptr));
            }
        }
